...
# ─────────────────────────────────────────
st.markdown("""
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Mono:wght@300;400;500&family=Outfit:wght@300;400;600;800&display=swap" rel="stylesheet">
<style>
...
with st.sidebar:
    ...
    <div class="sidebar-version">v3.0 · Gemini 1.5 Flash</div>
    """, unsafe_allow_html=True)
    ...
    with st.expander("Personalizza prompt"):
        custom_prompt = st.text_area("", value=DEFAULT_PROMPT, height=160,
                                     label_visibility="collapsed")
...
<div class="hero-block">
    ...
    <div class="hero-sub">Gemini 1.5 Flash · Audio peak detection · Montaggio automatico</div>
...
if files:
    ...
    if scan_btn:
        ...
        with st.status("", expanded=True) as stt:
